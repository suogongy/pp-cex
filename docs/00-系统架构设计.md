...
graph TD
    ...
    TradeService -.-> MySQL
    WalletService -.-> MySQL
    FinanceService -.-> MySQLSlave
    MarketService -.-> InfluxDB
    RiskService -.-> MinIO
    NotifyService -.-> MinIO

    MySQL -.-> ServiceReg
    MySQLSlave -.-> ServiceReg
    InfluxDB -.-> ConfigCenter
    MinIO -.-> ConfigCenter
    Gateway -.-> Monitoring
    Gateway -.-> Logging
    ...
    class CDN,DDoS,WAF cdnLayer
    class Gateway,Nacos,Sentinel,Route,LoadBalance,CircuitBreaker,Auth,Monitor gatewayLayer
    class UserService,TradeService,WalletService,FinanceService,MarketService,RiskService,NotifyService,MatchService serviceLayer
